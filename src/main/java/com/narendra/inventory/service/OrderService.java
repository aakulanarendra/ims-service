package com.narendra.inventory.service;
...
import com.narendra.inventory.dto.OrderDetails;
import com.narendra.inventory.dto.OrderProduct;
...
public class OrderService {
    ...
    public Customer getOrderCustomer(String orderId){
        ...
        return customerRepository.findById(Optional.ofNullable(order.getCustomer()).orElse(new com.narendra.inventory.dto.Customer()).getCustomerId()).orElse(new Customer());
    }
